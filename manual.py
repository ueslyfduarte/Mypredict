# manual# manual.py — MyPredict 2.0 (com processar_lista_simples)
import re
...
def processar_texto_ia(texto):
    ...
    # (O teu código antigo aqui, igual ao último que funcionou)
    pass  # Não vou repetir para não alongar; mantém o que já tens.
